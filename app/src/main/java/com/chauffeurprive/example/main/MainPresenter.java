...
import com.chauffeurprive.core.mvp.Presenter;
...
public class MainPresenter
    ...
    private final TimeOutInteractor timeOutInteractor;
    private Subscription submitSubscription;

    @Inject public MainPresenter(@NonNull MainViewModel viewModel,
    ...
    private void init() {
        Observable
                .combineLatest(email, password, (email, pass) ->
